...
namespace Infrastructure.Migrations
{
    public static class DbInitializer
    {
        ...
        private static Employee CreateEmployee1(Guid companyId)
        {
            ...
            var name = Name.Create("Employee 1 First Name",
                               "Employee 1 last name");
            var email = EmployeeEmail.Create("employee1@company1.com");
            var employee = new Employee(name, email, address, companyId);
        ...
        {
            var address = Address.Create("street", "city", "country").Value;
            var name = Name.Create("Employee 2 First Name",
                              "Employee 2 last name");
            var email = EmployeeEmail.Create("employee2@company1.com");
            var employee = new Employee(name, email, address, companyId);
